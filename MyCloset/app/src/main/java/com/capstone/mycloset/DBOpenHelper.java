...
public class DBOpenHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE coordi  (_id INTEGER PRIMARY KEY AUTOINCREMENT, name CHAR(20), " +
                "outerWear INTEGER, top_clothes INTEGER, botton_clothes INTEGER, shoes_clothes INTEGER);");
